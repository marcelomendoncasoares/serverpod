...
import 'providers/email/models/email_account_password_history.dart' as _i11;
import 'providers/email/models/email_account_password_reset_request.dart'
    as _i12;
import 'providers/email/models/email_account_request.dart' as _i13;
...
import 'providers/facebook/models/facebook_access_token_verification_exception.dart'
    as _i20;
import 'providers/facebook/models/facebook_account.dart' as _i21;
import 'providers/firebase/models/firebase_account.dart' as _i22;
...
export 'providers/email/models/email_account_password_history.dart';
...
class Protocol extends _i1.DatabaseSerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i11.EmailAccountPasswordHistory) {
      return _i11.EmailAccountPasswordHistory.fromJson(data) as T;
    }
    if (t == _i12.EmailAccountPasswordResetRequest) {
      return _i12.EmailAccountPasswordResetRequest.fromJson(data) as T;
    }
    ...
    if (t == _i15.EmailAccountLoginExceptionReason) {
      return _i15.EmailAccountLoginExceptionReason.fromJson(data) as T;
    }
    if (t == _i16.EmailAccountPasswordResetException) {
      return _i16.EmailAccountPasswordResetException.fromJson(data) as T;
    }
    if (t == _i17.EmailAccountPasswordResetExceptionReason) {
      return _i17.EmailAccountPasswordResetExceptionReason.fromJson(data) as T;
    }
    if (t == _i18.EmailAccountRequestException) {
      return _i18.EmailAccountRequestException.fromJson(data) as T;
    }
    if (t == _i19.EmailAccountRequestExceptionReason) {
      return _i19.EmailAccountRequestExceptionReason.fromJson(data) as T;
    }
    if (t == _i20.FacebookAccessTokenVerificationException) {
      return _i20.FacebookAccessTokenVerificationException.fromJson(data) as T;
    }
    if (t == _i21.FacebookAccount) {
      return _i21.FacebookAccount.fromJson(data) as T;
    }
    if (t == _i22.FirebaseAccount) {
      return _i22.FirebaseAccount.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i11.EmailAccountPasswordHistory?>()) {
      return (data != null
              ? _i11.EmailAccountPasswordHistory.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i12.EmailAccountPasswordResetRequest?>()) {
      return (data != null
              ? _i12.EmailAccountPasswordResetRequest.fromJson(data)
              : null)
          as T;
    }
    ...
    if (t == _i1.getType<_i15.EmailAccountLoginExceptionReason?>()) {
      return (data != null
              ? _i15.EmailAccountLoginExceptionReason.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i16.EmailAccountPasswordResetException?>()) {
      return (data != null
              ? _i16.EmailAccountPasswordResetException.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i17.EmailAccountPasswordResetExceptionReason?>()) {
      return (data != null
              ? _i17.EmailAccountPasswordResetExceptionReason.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i18.EmailAccountRequestException?>()) {
      return (data != null
              ? _i18.EmailAccountRequestException.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i19.EmailAccountRequestExceptionReason?>()) {
      return (data != null
              ? _i19.EmailAccountRequestExceptionReason.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i20.FacebookAccessTokenVerificationException?>()) {
      return (data != null
              ? _i20.FacebookAccessTokenVerificationException.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i21.FacebookAccount?>()) {
      return (data != null ? _i21.FacebookAccount.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i22.FirebaseAccount?>()) {
      return (data != null ? _i22.FirebaseAccount.fromJson(data) : null) as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i11.EmailAccountPasswordHistory => 'EmailAccountPasswordHistory',
      _i12.EmailAccountPasswordResetRequest =>
        'EmailAccountPasswordResetRequest',
      _i13.EmailAccountRequest => 'EmailAccountRequest',
      _i14.EmailAccountLoginException => 'EmailAccountLoginException',
      _i15.EmailAccountLoginExceptionReason =>
        'EmailAccountLoginExceptionReason',
      _i16.EmailAccountPasswordResetException =>
        'EmailAccountPasswordResetException',
      _i17.EmailAccountPasswordResetExceptionReason =>
        'EmailAccountPasswordResetExceptionReason',
      _i18.EmailAccountRequestException => 'EmailAccountRequestException',
      _i19.EmailAccountRequestExceptionReason =>
        'EmailAccountRequestExceptionReason',
      _i20.FacebookAccessTokenVerificationException =>
        'FacebookAccessTokenVerificationException',
      _i21.FacebookAccount => 'FacebookAccount',
      _i22.FirebaseAccount => 'FirebaseAccount',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i10.EmailAccount():
        return 'EmailAccount';
      case _i11.EmailAccountPasswordHistory():
        return 'EmailAccountPasswordHistory';
      case _i12.EmailAccountPasswordResetRequest():
      ...
      case _i15.EmailAccountLoginExceptionReason():
        return 'EmailAccountLoginExceptionReason';
      case _i16.EmailAccountPasswordResetException():
        return 'EmailAccountPasswordResetException';
      case _i17.EmailAccountPasswordResetExceptionReason():
        return 'EmailAccountPasswordResetExceptionReason';
      case _i18.EmailAccountRequestException():
        return 'EmailAccountRequestException';
      case _i19.EmailAccountRequestExceptionReason():
        return 'EmailAccountRequestExceptionReason';
      case _i20.FacebookAccessTokenVerificationException():
        return 'FacebookAccessTokenVerificationException';
      case _i21.FacebookAccount():
        return 'FacebookAccount';
      case _i22.FirebaseAccount():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'EmailAccountPasswordHistory') {
      return deserialize<_i11.EmailAccountPasswordHistory>(data['data']);
    }
    if (dataClassName == 'EmailAccountPasswordResetRequest') {
      return deserialize<_i12.EmailAccountPasswordResetRequest>(data['data']);
    }
    ...
    if (dataClassName == 'EmailAccountLoginExceptionReason') {
      return deserialize<_i15.EmailAccountLoginExceptionReason>(data['data']);
    }
    if (dataClassName == 'EmailAccountPasswordResetException') {
      return deserialize<_i16.EmailAccountPasswordResetException>(data['data']);
    }
    if (dataClassName == 'EmailAccountPasswordResetExceptionReason') {
      return deserialize<_i17.EmailAccountPasswordResetExceptionReason>(
        data['data'],
      );
    }
    if (dataClassName == 'EmailAccountRequestException') {
      return deserialize<_i18.EmailAccountRequestException>(data['data']);
    }
    if (dataClassName == 'EmailAccountRequestExceptionReason') {
      return deserialize<_i19.EmailAccountRequestExceptionReason>(data['data']);
    }
    if (dataClassName == 'FacebookAccessTokenVerificationException') {
      return deserialize<_i20.FacebookAccessTokenVerificationException>(
        data['data'],
      );
    }
    if (dataClassName == 'FacebookAccount') {
      return deserialize<_i21.FacebookAccount>(data['data']);
    }
    if (dataClassName == 'FirebaseAccount') {
      return deserialize<_i22.FirebaseAccount>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i11.EmailAccountPasswordHistory:
        return _i11.EmailAccountPasswordHistory.t;
      case _i12.EmailAccountPasswordResetRequest:
        return _i12.EmailAccountPasswordResetRequest.t;
      case _i13.EmailAccountRequest:
        return _i13.EmailAccountRequest.t;
      case _i21.FacebookAccount:
        return _i21.FacebookAccount.t;
      case _i22.FirebaseAccount:
        return _i22.FirebaseAccount.t;
      case _i25.GitHubAccount:
