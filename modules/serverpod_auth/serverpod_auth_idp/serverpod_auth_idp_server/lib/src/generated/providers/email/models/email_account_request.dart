  ...
  factory EmailAccountRequest.fromJson(Map<String, dynamic> jsonSerialization) {
    return _EmailAccountRequestImpl(
      ...
      createAccountChallenge:
          jsonSerialization.containsKey('createAccountChallenge')
...
class EmailAccountRequestRepository {
  ...
  /// Emits [EmailAccountRequest]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `EmailAccountRequest.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<EmailAccountRequest>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<EmailAccountRequestTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<EmailAccountRequest>(
      where: where?.call(EmailAccountRequest.t),
      orderBy: orderBy?.call(EmailAccountRequest.t),
      orderByList: orderByList?.call(EmailAccountRequest.t),
      limit: limit,
