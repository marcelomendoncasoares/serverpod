...
void main() {
  group('Given a ColumnVector', () {
    var columnName = 'embedding';
    var dimension = 3;
    var column = ColumnVector(
      columnName,
    ...
    test('when type is called then Vector is returned.', () {
      expect(column.type, Vector);
    });
    ...
    group('with vector-specific distance operations', () {
      ...
      test(
          ...
          () {
        var testVector = const Vector([1.0, 2.0, 3.0]);
        var comparisonExpression = column.distanceHamming(testVector);
      ...
      test(
          ...
          () {
        var testVector = const Vector([1.0, 2.0, 3.0]);
        var comparisonExpression = column.distanceJaccard(testVector);
