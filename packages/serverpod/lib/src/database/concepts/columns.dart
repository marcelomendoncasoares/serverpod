...
mixin _VectorColumnDefaultOperations on _ValueOperatorColumn<Vector> {
  ...
  /// Computes the Hamming distance between this vector column and another binary vector.
  ColumnVectorDistance distanceHamming(Vector other) {
    return ColumnVectorDistance(VectorDistanceExpression(
      this,
      _encodeValueForQuery(other),
  ...
  /// Computes the Jaccard distance between this vector column and another binary vector.
  ColumnVectorDistance distanceJaccard(Vector other) {
    return ColumnVectorDistance(VectorDistanceExpression(
      this,
      _encodeValueForQuery(other),
