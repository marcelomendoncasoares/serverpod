...
final class _SqliteDatabaseQueryException extends DatabaseQueryException {
  ...
  factory _SqliteDatabaseQueryException.fromSqliteException(SqliteException e) {
...
final class _SqliteDatabaseInsertRowException extends DatabaseInsertRowException {
  @override
  final String message;
...
final class _SqliteDatabaseUpdateRowException extends DatabaseUpdateRowException {
  @override
  final String message;
...
final class _SqliteDatabaseDeleteRowException extends DatabaseDeleteRowException {
  @override
  final String message;
