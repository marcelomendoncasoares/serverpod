...
abstract class ServerpodClientShared extends EndpointCaller {
  ...
  // TODO: Solve all the deprecation warnings on the repo.
  /// Optional [AuthenticationKeyManager] if the client needs to sign the user in.
  @Deprecated('Use the `authKeyProvider` parameter to use authentication.')
  ...
  // TODO: Add the `authKeyProvider` on the code generation.
