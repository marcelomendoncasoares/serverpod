...
void main() {
  ...
  test(
    'Given a Vector, serializing to JSON returns a List<double> representation.',
    () {
  ...
  test(
    ...
    () {
      ...
      expect(vector.toJson(), isA<List<double>>());
      expect(vector.toJson(), [1.0, 0.0, 2.0, 0.0, 3.0]);
    },
  );
  ...
  test(
    'Given UndecodedBytes, when deserialized to a SparseVector using SparseVectorJsonExtension.fromJson, then it creates a valid SparseVector.',
    () {
      ...
      SparseVector vector = SparseVectorJsonExtension.fromJson(undecoded);
  ...
  test(
    'Given a List<double>, when deserialized to a SparseVector and then serialized back to a List<double>, then it matches the original list.',
    () {
  ...
  test(
    'Given a Bit vector, serializing to JSON returns a List<bool> representation.',
    () {
      Bit vector = Bit([true, false, true, false, true]);

      expect(vector.toJson(), isA<List<bool>>());
      expect(vector.toJson(), [true, false, true, false, true]);
    },
  );
  ...
  test(
    'Given UndecodedBytes, when deserialized to a Bit using BitJsonExtension.fromJson, then it creates a valid Bit vector.',
    () {
      ...
      Bit vector = BitJsonExtension.fromJson(undecoded);
  ...
  test(
    'Given a List<bool>, when deserialized to a Bit and then serialized back to a List<bool>, then it matches the original list.',
    () {
