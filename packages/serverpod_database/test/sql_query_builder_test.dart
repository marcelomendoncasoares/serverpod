  ...
  group('Given SelectQueryBuilder', () {
    ...
    test(
      ...
      () {
        var query = SelectQueryBuilder(
          table: citizenTable,
        ).withWhere(const Expression('"test"=@test')).build();
    ...
    test(
      ...
      () {
        ...
        var query = SelectQueryBuilder(
          table: citizenTable,
        ).withWhere(combinedExpression).build();
  ...
  group('Given CountQueryBuilder', () {
    ...
    test(
      ...
      () {
        var query = CountQueryBuilder(
          table: citizenTable,
        ).withField(ColumnInt('age', citizenTable)).build();
  ...
  group('Given DeleteQueryBuilder', () {
    ...
    test(
      ...
      () {
        var query = DeleteQueryBuilder(
          table: citizenTable,
        ).withReturn(Returning.all).build();
