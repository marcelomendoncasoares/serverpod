...
extension DatabaseDefinitionPgSqlGeneration on DatabaseDefinition {
  String toSql({
    ...
    return SqlGenerator.generateDatabaseDefinitionSql(
      dialect,
      this,
...
extension PostgresMigrationSqlGeneration on DatabaseMigration {
  String toSql({
    required List<DatabaseMigrationVersion> installedModules,
    required List<DatabaseMigrationVersion> removedModules,
    required DatabaseDialect dialect,
  }) {
    return SqlGenerator.generateDatabaseMigrationSql(
      dialect,
      this,
      installedModules: installedModules,
