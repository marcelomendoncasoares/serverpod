...
void main() {
  ...
  group('Given endpoint with @unauthenticated annotation when analyzed', () {
...
''');
    ...
    test('then endpoint has unauthenticated annotation.', () {
  ...
  group('Given endpoint method with @unauthenticated annotation when analyzed',
      () {
    var collector = CodeGenerationCollector();
    var testDirectory =
        Directory(path.join(testProjectDirectory.path, const Uuid().v4()));
...
''');
    ...
    test('then method has unauthenticated annotation.', () {
      var endpoint = endpointDefinitions.first;
    ...
    test('then other method does not have unauthenticated annotation.', () {
      var endpoint = endpointDefinitions.first;
