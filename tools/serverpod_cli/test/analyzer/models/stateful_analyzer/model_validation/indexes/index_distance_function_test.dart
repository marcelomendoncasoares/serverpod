...
void main() {
  ...
  test(
    ...
    expect(
      error.message,
      '"invalid_distance" is not a valid property. Valid properties are (l2, '
      'innerProduct, cosine, l1, hamming, jaccard).',
    );
  });
  ...
  test(
    ...
    expect(
      error.message,
      '"123" is not a valid property. Valid properties are (l2, innerProduct, '
      'cosine, l1, hamming, jaccard).',
    );
  });
