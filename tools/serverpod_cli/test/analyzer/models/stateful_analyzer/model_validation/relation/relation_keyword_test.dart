    ...
    group('', () {
      ...
      test(
        ...
        () {
          ...
          expect(relation.runtimeType, ForeignRelationDefinition);
          expect(
            (relation as ForeignRelationDefinition).foreignFieldName,
            'id',
          );
        },
      );
...
fields:
  ...
  group(
    ...
    () {
      ...
      test(
        'then a relation with the parent table is set on the relation field.',
        () {
      ...
      test(
        'then a relation with the reference id is set on the relation field.',
        () {
          var relation = classDefinition.findField('parentId')?.relation;
