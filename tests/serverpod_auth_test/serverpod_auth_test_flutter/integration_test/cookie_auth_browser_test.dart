...
void main() {
  ...
  testWidgets(
    ...
    (_) async {
      ...
      // The deprecated endpoint stream remains part of the public client API;
      // cookie mode must authenticate its handshake instead of sending a null
      // in-band key and silently becoming anonymous.
      // ignore: deprecated_member_use
      await client.openStreamingConnection(
        disconnectOnLostInternetConnection: false,
      );
      try {
        final legacyMessage = await client.authTest.stream.first as UserData;
        expect(legacyMessage.displayName, userId.toString());
      } finally {
        // ignore: deprecated_member_use
