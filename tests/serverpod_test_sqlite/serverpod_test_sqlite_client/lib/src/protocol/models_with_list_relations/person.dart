...
class PersonImplicit extends _PersonImpl {
  ...
  factory PersonImplicit(
    ...
    return PersonImplicit._(
      ...
      organization: person._organization,
      $_cityCitizensCityId: $_cityCitizensCityId,
    );
  }
...
class PersonUpdateTable extends _isd.UpdateTable<PersonTable> {
  ...
  _isd.ColumnValue<int, int> organizationId(int? value) => _isd.ColumnValue(
    table.organizationId,
    value,
  );

  _isd.ColumnValue<int, int> $_cityCitizensCityId(int? value) =>
      _isd.ColumnValue(
...
class PersonTable extends _isd.Table<int?> {
  PersonTable({super.tableRelation}) : super(tableName: 'person') {
    ...
    organizationId = _isd.ColumnInt(
      'organizationId',
      this,
    );
    $_cityCitizensCityId = _isd.ColumnInt(
      '_cityCitizensCityId',
      this,
    );
  }
  ...
  late final _isd.ColumnInt organizationId;

  _i0ptycc3.OrganizationTable? _organization;

  late final _isd.ColumnInt $_cityCitizensCityId;
