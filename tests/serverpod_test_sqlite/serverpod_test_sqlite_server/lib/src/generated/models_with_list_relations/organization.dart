...
abstract class Organization
  ...
  factory Organization.fromJson(Map<String, dynamic> jsonSerialization) {
    return _OrganizationImpl(
      ...
      people: jsonSerialization['people'] == null
          ? null
          : _i08l111i.Protocol().deserialize<List<_ijqkgw0m.Person>>(
      ...
      city: jsonSerialization.containsKey('city')
          ? jsonSerialization['city'] == null
                ? null
                : _i08l111i.Protocol().deserialize<_i64066zp.City>(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (_city is! _issu.UndefinedSentinel) 'city': _city?.toJson(),
    };
  }
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      if (cityId != null) 'cityId': cityId,
      if (_city is! _issu.UndefinedSentinel) 'city': _city?.toJsonForProtocol(),
    };
  }
...
class _OrganizationImpl extends Organization {
  ...
  Organization copyWith({
    ...
    return _OrganizationImpl(
      ...
      city: city is _issu.UndefinedSentinel
          ? _city is _issu.UndefinedSentinel
                ? _city
                : this._city?.copyWith()
          : city?.copyWith(),
    );
...
class OrganizationRepository {
  ...
  /// Emits [Organization]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `Organization.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<Organization>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<OrganizationTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<Organization>(
      where: where?.call(Organization.t),
      orderBy: orderBy?.call(Organization.t),
      orderByList: orderByList?.call(Organization.t),
      limit: limit,
