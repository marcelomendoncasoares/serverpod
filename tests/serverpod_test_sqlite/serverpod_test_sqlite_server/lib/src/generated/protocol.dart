...
import 'changed_id_type/server_only.dart' as _i20;
import 'custom_class_roundtrip_table.dart' as _i21;
...
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i146;
...
class Protocol extends _i1.DatabaseSerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i20.ServerOnlyChangedIdFieldClass) {
      return _i20.ServerOnlyChangedIdFieldClass.fromJson(data) as T;
    }
    if (t == _i21.CustomClassRoundtripTable) {
      return _i21.CustomClassRoundtripTable.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i123.ObjectWithJsonb?>()) {
      return (data != null ? _i123.ObjectWithJsonb.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i124.ObjectWithJsonbClassLevel?>()) {
      return (data != null
              ? _i124.ObjectWithJsonbClassLevel.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i125.ObjectWithMaps?>()) {
    ...
    if (t == _i1.getType<List<_i7.EnrollmentInt>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i7.EnrollmentInt>(e))
                    .toList()
    ...
    if (t == _i1.getType<List<_i10.PlayerUuid>?>()) {
      return (data != null
              ? (data as List)
    ...
    if (t == _i1.getType<List<_i14.OrderUuid>?>()) {
      return (data != null
              ? (data as List)
    ...
    if (t == _i1.getType<List<_i12.CommentInt>?>()) {
      return (data != null
              ? (data as List)
    ...
    if (t == _i1.getType<List<_i19.ChangedIdTypeSelf>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i19.ChangedIdTypeSelf>(e))
                    .toList()
    ...
    if (t == _i146.IntCustomClass) {
      return _i146.IntCustomClass.fromJson(data) as T;
    }
    if (t == _i146.DoubleCustomClass) {
      return _i146.DoubleCustomClass.fromJson(data) as T;
    }
    if (t == _i146.CustomClass) {
      return _i146.CustomClass.fromJson(data) as T;
    }
    if (t == _i146.BoolCustomClass) {
      return _i146.BoolCustomClass.fromJson(data) as T;
    }
    if (t == _i146.DateTimeCustomClass) {
      return _i146.DateTimeCustomClass.fromJson(data) as T;
    }
    if (t == _i146.CustomClass2) {
      return _i146.CustomClass2.fromJson(data) as T;
    }
    if (t == _i1.getType<_i146.IntCustomClass?>()) {
      return (data != null ? _i146.IntCustomClass.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i146.CustomClass2?>()) {
      return (data != null ? _i146.CustomClass2.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<List<List<_i135.SimpleData>>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<List<_i135.SimpleData>>(e))
                    .toList()
    ...
    if (t == _i1.getType<List<Map<int, _i135.SimpleData>>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<Map<int, _i135.SimpleData>>(e))
                    .toList()
    ...
    if (t ==
        _i1.getType<Map<String, List<List<Map<int, _i135.SimpleData>>?>>?>()) {
      return (data != null
              ? (data as Map).map(
                  (k, v) => MapEntry(
                    deserialize<String>(k),
    ...
    if (t == _i1.getType<Map<String, Map<int, _i135.SimpleData>>?>()) {
      return (data != null
              ? (data as Map).map(
                  (k, v) => MapEntry(
                    deserialize<String>(k),
    ...
    if (t == _i1.getType<_i146.CustomClass?>()) {
      return (data != null ? _i146.CustomClass.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i146.CustomClass2?>()) {
      return (data != null ? _i146.CustomClass2.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i146.DoubleCustomClass?>()) {
      return (data != null ? _i146.DoubleCustomClass.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i146.BoolCustomClass?>()) {
      return (data != null ? _i146.BoolCustomClass.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i146.DateTimeCustomClass?>()) {
      return (data != null ? _i146.DateTimeCustomClass.fromJson(data) : null)
          as T;
    }
    try {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      _i146.CustomClass => 'CustomClass',
      _i146.CustomClass2 => 'CustomClass2',
      _i146.IntCustomClass => 'IntCustomClass',
      _i146.DoubleCustomClass => 'DoubleCustomClass',
      _i146.BoolCustomClass => 'BoolCustomClass',
      _i146.DateTimeCustomClass => 'DateTimeCustomClass',
      ...
      _i20.ServerOnlyChangedIdFieldClass => 'ServerOnlyChangedIdFieldClass',
      _i21.CustomClassRoundtripTable => 'CustomClassRoundtripTable',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      case _i146.CustomClass():
        return 'CustomClass';
      case _i146.CustomClass2():
        return 'CustomClass2';
      case _i146.IntCustomClass():
        return 'IntCustomClass';
      case _i146.DoubleCustomClass():
        return 'DoubleCustomClass';
      case _i146.BoolCustomClass():
        return 'BoolCustomClass';
      case _i146.DateTimeCustomClass():
      ...
      case _i20.ServerOnlyChangedIdFieldClass():
        return 'ServerOnlyChangedIdFieldClass';
      case _i21.CustomClassRoundtripTable():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'CustomClass') {
      return deserialize<_i146.CustomClass>(data['data']);
    }
    if (dataClassName == 'CustomClass2') {
      return deserialize<_i146.CustomClass2>(data['data']);
    }
    if (dataClassName == 'IntCustomClass') {
      return deserialize<_i146.IntCustomClass>(data['data']);
    }
    if (dataClassName == 'DoubleCustomClass') {
      return deserialize<_i146.DoubleCustomClass>(data['data']);
    }
    if (dataClassName == 'BoolCustomClass') {
      return deserialize<_i146.BoolCustomClass>(data['data']);
    }
    if (dataClassName == 'DateTimeCustomClass') {
      return deserialize<_i146.DateTimeCustomClass>(data['data']);
    }
    ...
    if (dataClassName == 'ServerOnlyChangedIdFieldClass') {
      return deserialize<_i20.ServerOnlyChangedIdFieldClass>(data['data']);
    }
    if (dataClassName == 'CustomClassRoundtripTable') {
      return deserialize<_i21.CustomClassRoundtripTable>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      case _i6.CourseUuid:
        return _i6.CourseUuid.t;
      case _i7.EnrollmentInt:
        return _i7.EnrollmentInt.t;
      case _i8.StudentUuid:
        return _i8.StudentUuid.t;
      case _i9.ArenaUuid:
        return _i9.ArenaUuid.t;
      case _i10.PlayerUuid:
        return _i10.PlayerUuid.t;
      case _i11.TeamInt:
        return _i11.TeamInt.t;
      case _i12.CommentInt:
        return _i12.CommentInt.t;
      case _i13.CustomerInt:
        return _i13.CustomerInt.t;
      case _i14.OrderUuid:
        return _i14.OrderUuid.t;
      case _i15.AddressUuid:
        return _i15.AddressUuid.t;
      case _i16.CitizenInt:
        return _i16.CitizenInt.t;
      case _i17.CompanyUuid:
        return _i17.CompanyUuid.t;
      case _i18.TownInt:
        return _i18.TownInt.t;
      case _i19.ChangedIdTypeSelf:
        return _i19.ChangedIdTypeSelf.t;
      case _i20.ServerOnlyChangedIdFieldClass:
        return _i20.ServerOnlyChangedIdFieldClass.t;
      case _i21.CustomClassRoundtripTable:
        return _i21.CustomClassRoundtripTable.t;
      case _i22.BigIntDefault:
      ...
      case _i117.ObjectWithDuration:
        return _i117.ObjectWithDuration.t;
      case _i118.ObjectWithDynamic:
        return _i118.ObjectWithDynamic.t;
      case _i119.ObjectWithEnum:
        return _i119.ObjectWithEnum.t;
      case _i120.ObjectWithEnumEnhanced:
        return _i120.ObjectWithEnumEnhanced.t;
      case _i121.ObjectWithHalfVector:
        return _i121.ObjectWithHalfVector.t;
      case _i122.ObjectWithIndex:
        return _i122.ObjectWithIndex.t;
      case _i123.ObjectWithJsonb:
        return _i123.ObjectWithJsonb.t;
      case _i124.ObjectWithJsonbClassLevel:
        return _i124.ObjectWithJsonbClassLevel.t;
      case _i126.ObjectWithObject:
        return _i126.ObjectWithObject.t;
      case _i127.ObjectWithParent:
        return _i127.ObjectWithParent.t;
      case _i129.ObjectWithSelfParent:
        return _i129.ObjectWithSelfParent.t;
      case _i130.ObjectWithSparseVector:
        return _i130.ObjectWithSparseVector.t;
      case _i131.ObjectWithUuid:
        return _i131.ObjectWithUuid.t;
      case _i132.ObjectWithVector:
        return _i132.ObjectWithVector.t;
      case _i133.RelatedUniqueData:
      ...
      case _i145.UpsertTestModel:
        return _i145.UpsertTestModel.t;
    }
    return null;
  }
