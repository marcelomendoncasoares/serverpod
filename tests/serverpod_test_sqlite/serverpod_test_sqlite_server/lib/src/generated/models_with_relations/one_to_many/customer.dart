  ...
  factory Customer.fromJson(Map<String, dynamic> jsonSerialization) {
    return _CustomerImpl(
      ...
      orders: jsonSerialization['orders'] == null
          ? null
          : _i08l111i.Protocol().deserialize<List<_ig920ya2.Order>>(
...
class CustomerTable extends _is.Table<int?> {
  ...
  _is.ManyRelation<_ig920ya2.OrderTable>? _orders;
  ...
  _is.ManyRelation<_ig920ya2.OrderTable> get orders {
    ...
    _orders = _is.ManyRelation<_ig920ya2.OrderTable>(
