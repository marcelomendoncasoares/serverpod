...
CREATE TABLE "child_entity" (
    ...
    "_parentEntityChildrenParentEntityId" INTEGER,
...
CREATE TABLE "uuid_default" (
    ...
    "uuidDefaultStr" BLOB NOT NULL DEFAULT (unhex('550e8400e29b41d4a716446655440000')),
...
CREATE TABLE "uuid_default_mix" (
    "id" INTEGER PRIMARY KEY,
    "uuidDefaultAndDefaultModel" BLOB NOT NULL DEFAULT (unhex('3f2504e04f8911d39a0c0305e82c3301')),
    "uuidDefaultAndDefaultPersist" BLOB NOT NULL DEFAULT (unhex('9e107d9d372b4d979b272f0907d0b1d4')),
