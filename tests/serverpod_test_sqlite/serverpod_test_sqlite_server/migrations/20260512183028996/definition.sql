...
--
-- Class DecimalDefault as table decimal_default
--
...
--
-- Class DecimalDefaultMix as table decimal_default_mix
--
...
--
-- Class DecimalDefaultModel as table decimal_default_model
--
...
--
-- Class DecimalDefaultPersist as table decimal_default_persist
--
...
--
-- Class ObjectWithDecimal as table object_with_decimal
--
...
--
-- Class ObjectWithDecimalPrecision as table object_with_decimal_precision
--
...
-- Indexes
CREATE UNIQUE INDEX "code_unique_idx" ON "upsert_test_model" ("code");
CREATE UNIQUE INDEX "category_value_unique_idx" ON "upsert_test_model" ("category", "value");
