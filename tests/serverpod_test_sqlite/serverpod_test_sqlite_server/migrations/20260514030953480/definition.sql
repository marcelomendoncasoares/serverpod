...
--
-- Class SharedTableModel as table shared_table_model
--
CREATE TABLE "shared_table_model" (
    "id" INTEGER PRIMARY KEY,
    "name" TEXT NOT NULL
) STRICT;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_sqlite', '20260514030953480', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260514030953480', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
