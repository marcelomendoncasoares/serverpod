...
--
-- Class CustomClassRoundtripTable as table custom_class_roundtrip_table
--
CREATE TABLE "custom_class_roundtrip_table" (
    ...
    "boolData" INTEGER NOT NULL,
    "dateTimeData" INTEGER NOT NULL,
    "mapData" TEXT NOT NULL,
    "jsonbMapData" BLOB NOT NULL,
    "nullableIntData" INTEGER,
    "nullableMapData" TEXT
) STRICT;
...
--
-- Class SharedTableRecord as table shared_table_record
--
...
-- Indexes
CREATE UNIQUE INDEX "upsert_test_model__code__unique_idx" ON "upsert_test_model" ("code");
CREATE UNIQUE INDEX "upsert_test_model__category__value__unique_idx" ON "upsert_test_model" ("category", "value");
...
INSERT INTO "serverpod_sqlite_schema" VALUES
    ...
    ('custom_class_roundtrip_table', 'boolData', 'boolean', NULL),
    ('custom_class_roundtrip_table', 'dateTimeData', 'timestampWithoutTimeZone', NULL),
    ('custom_class_roundtrip_table', 'mapData', 'json', NULL),
    ('custom_class_roundtrip_table', 'jsonbMapData', 'jsonb', NULL),
    ('custom_class_roundtrip_table', 'nullableMapData', 'json', NULL),
    ...
    ('shared_table_record', 'sharedSubclass', 'json', NULL),
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_sqlite', '20260724164916256', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724164916256', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
