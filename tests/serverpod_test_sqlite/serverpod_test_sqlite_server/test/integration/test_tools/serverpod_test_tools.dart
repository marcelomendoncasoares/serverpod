...
class _TestToolsEndpoint {
  ...
  _i3.Future<List<_i4.SimpleData>> returnsSimpleDataListFromInputStream(
    _i1.TestSessionBuilder sessionBuilder,
    _i3.Stream<_i4.SimpleData> simpleDatas,
  ) async {
    var _localTestStreamManager = _i1.TestStreamManager<List<_i4.SimpleData>>();
    return _i1.callAwaitableFunctionWithStreamInputAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
  ...
  _i3.Stream<_i4.SimpleData> returnsSimpleDataStreamFromInputStream(
    _i1.TestSessionBuilder sessionBuilder,
    _i3.Stream<_i4.SimpleData> simpleDatas,
  ) {
    var _localTestStreamManager = _i1.TestStreamManager<_i4.SimpleData>();
    _i1.callStreamFunctionAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
  ...
  _i3.Future<_i4.SimpleData> echoSimpleData(
    _i1.TestSessionBuilder sessionBuilder,
  ...
  _i3.Future<List<_i4.SimpleData>> echoSimpleDatas(
    _i1.TestSessionBuilder sessionBuilder,
  ...
  _i3.Future<_i5.Types> echoTypes(
    _i1.TestSessionBuilder sessionBuilder,
    _i5.Types typesModel,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
  ...
  _i3.Future<List<_i5.Types>> echoTypesList(
    _i1.TestSessionBuilder sessionBuilder,
    List<_i5.Types> typesList,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await _localCallContext.method
            ...
            .then(
              (record) =>
                  _i6.Protocol().deserialize<(String, (int, bool))>(record),
            );
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
  ...
  _i3.Future<(int, _i4.SimpleData)> returnRecordWithSerializableObject(
    _i1.TestSessionBuilder sessionBuilder,
    int number,
    _i4.SimpleData data,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await _localCallContext.method
            ...
            .then(
              (record) =>
                  _i6.Protocol().deserialize<(int, _i4.SimpleData)>(record),
            );
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      ...
      () async {
        ...
        var _localCallContext = await _endpointDispatch
            .getMethodStreamCallContext(
              ...
              arguments: {
                'initialValue': _i7.jsonDecode(
                  _i2.SerializationManager.encode(
                    _i6.Protocol().mapRecordToJson(initialValue),
                  ),
                ),
              },
        ...
        var _localCallContext = await _endpointDispatch
            .getMethodStreamCallContext(
              ...
              arguments: {
                'initialValue': _i7.jsonDecode(
                  _i2.SerializationManager.encode(
                    _i6.Protocol().mapContainerToJson(initialValue),
                  ),
                ),
              },
              requestedInputStreams: ['stream'],
  ...
  _i3.Stream<_i8.TypesRecord?> modelWithRecordsEchoStream(
    _i1.TestSessionBuilder sessionBuilder,
    _i8.TypesRecord? initialValue,
    _i3.Stream<_i8.TypesRecord?> stream,
  ) {
    var _localTestStreamManager = _i1.TestStreamManager<_i8.TypesRecord?>();
    _i1.callStreamFunctionAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
  ...
  _i3.Future<_i4.SimpleData?> getFromLocalCache(
    _i1.TestSessionBuilder sessionBuilder,
    String key,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<_i4.SimpleData?> getFromLocalPrioCache(
    _i1.TestSessionBuilder sessionBuilder,
    String key,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<_i4.SimpleData?> getFromQueryCache(
    _i1.TestSessionBuilder sessionBuilder,
    String key,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
