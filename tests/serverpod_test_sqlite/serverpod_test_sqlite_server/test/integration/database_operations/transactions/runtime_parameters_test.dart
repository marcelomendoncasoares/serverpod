...
void main() async {
  // SET LOCAL and current_setting are PostgreSQL-specific; SQLite does not
  // support them. setRuntimeParameters is a no-op (stores options only).
  group(
    'runtime parameters',
    () {
    ...
    skip: 'SQLite does not support SET LOCAL or current_setting',
  );
}
