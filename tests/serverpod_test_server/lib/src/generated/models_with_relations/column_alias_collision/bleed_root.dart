...
class BleedRootRepository {
  ...
  /// Upserts all [BleedRoot]s in the list and returns the resulting rows.
  ///
  ...
  Future<List<BleedRoot>> upsert(
    ...
    return session.db.upsert<BleedRoot>(
      rows,
      conflictColumns: conflictColumns(BleedRoot.t),
  ...
  /// Upserts a single [BleedRoot] and returns the resulting row.
  ///
