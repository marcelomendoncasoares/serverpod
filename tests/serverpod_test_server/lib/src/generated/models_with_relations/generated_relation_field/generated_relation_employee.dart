...
class GeneratedRelationEmployeeRepository {
  ...
  /// Emits [GeneratedRelationEmployee]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `GeneratedRelationEmployee.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<GeneratedRelationEmployee>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<GeneratedRelationEmployeeTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<GeneratedRelationEmployee>(
      where: where?.call(GeneratedRelationEmployee.t),
      orderBy: orderBy?.call(GeneratedRelationEmployee.t),
      orderByList: orderByList?.call(GeneratedRelationEmployee.t),
      limit: limit,
