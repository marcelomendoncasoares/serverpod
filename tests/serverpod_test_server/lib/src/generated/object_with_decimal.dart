...
class ObjectWithDecimalUpdateTable
  ...
  _i1.ColumnValue<_i1.Decimal, _i1.Decimal> decimalValue(_i1.Decimal value) =>
      _i1.ColumnValue(
        table.decimalValue,
        value,
      );

  _i1.ColumnValue<_i1.Decimal, _i1.Decimal> decimalValueNull(
    _i1.Decimal? value,
  ) => _i1.ColumnValue(
    table.decimalValueNull,
    value,
  );
}
...
class ObjectWithDecimalTable extends _i1.Table<int?> {
  ObjectWithDecimalTable({super.tableRelation})
    ...
    decimalValue = _i1.ColumnDecimal(
      'decimalValue',
      this,
    );
    decimalValueNull = _i1.ColumnDecimal(
      'decimalValueNull',
      this,
    );
  }
  ...
  late final _i1.ColumnDecimal decimalValue;

  late final _i1.ColumnDecimal decimalValueNull;
...
class ObjectWithDecimalRepository {
  ...
  /// Upserts all [ObjectWithDecimal]s in the list and returns the resulting rows.
  ///
  ...
  Future<List<ObjectWithDecimal>> upsert(
    _i1.DatabaseSession session,
    List<ObjectWithDecimal> rows, {
    required _i1.ColumnSelections<ObjectWithDecimalTable> conflictColumns,
    _i1.ColumnSelections<ObjectWithDecimalTable>? updateColumns,
    _i1.WhereExpressionBuilder<ObjectWithDecimalTable>? updateWhere,
    _i1.Transaction? transaction,
  }) async {
    return session.db.upsert<ObjectWithDecimal>(
      rows,
      conflictColumns: conflictColumns(ObjectWithDecimal.t),
      updateColumns: updateColumns?.call(ObjectWithDecimal.t),
      updateWhere: updateWhere?.call(ObjectWithDecimal.t),
      transaction: transaction,
    );
  }

  /// Upserts a single [ObjectWithDecimal] and returns the resulting row.
  ///
  ...
  ///
  /// The returned [ObjectWithDecimal] will have its `id` field set.
  Future<ObjectWithDecimal?> upsertRow(
    _i1.DatabaseSession session,
    ObjectWithDecimal row, {
    required _i1.ColumnSelections<ObjectWithDecimalTable> conflictColumns,
    _i1.ColumnSelections<ObjectWithDecimalTable>? updateColumns,
    ...
    return session.db.upsertRow<ObjectWithDecimal>(
      row,
      conflictColumns: conflictColumns(ObjectWithDecimal.t),
      updateColumns: updateColumns?.call(ObjectWithDecimal.t),
      updateWhere: updateWhere?.call(ObjectWithDecimal.t),
