...
class DecimalDefaultMixRepository {
  ...
  /// Upserts all [DecimalDefaultMix]s in the list and returns the resulting rows.
  ///
  ...
  Future<List<DecimalDefaultMix>> upsert(
    _i1.DatabaseSession session,
    List<DecimalDefaultMix> rows, {
    required _i1.ColumnSelections<DecimalDefaultMixTable> conflictColumns,
    _i1.ColumnSelections<DecimalDefaultMixTable>? updateColumns,
    _i1.WhereExpressionBuilder<DecimalDefaultMixTable>? updateWhere,
    _i1.Transaction? transaction,
  }) async {
    return session.db.upsert<DecimalDefaultMix>(
      rows,
      conflictColumns: conflictColumns(DecimalDefaultMix.t),
      updateColumns: updateColumns?.call(DecimalDefaultMix.t),
      updateWhere: updateWhere?.call(DecimalDefaultMix.t),
      transaction: transaction,
    );
  }

  /// Upserts a single [DecimalDefaultMix] and returns the resulting row.
  ///
  ...
  ///
  /// The returned [DecimalDefaultMix] will have its `id` field set.
  Future<DecimalDefaultMix?> upsertRow(
    _i1.DatabaseSession session,
    DecimalDefaultMix row, {
    required _i1.ColumnSelections<DecimalDefaultMixTable> conflictColumns,
    _i1.ColumnSelections<DecimalDefaultMixTable>? updateColumns,
    ...
    return session.db.upsertRow<DecimalDefaultMix>(
      row,
      conflictColumns: conflictColumns(DecimalDefaultMix.t),
      updateColumns: updateColumns?.call(DecimalDefaultMix.t),
      updateWhere: updateWhere?.call(DecimalDefaultMix.t),
