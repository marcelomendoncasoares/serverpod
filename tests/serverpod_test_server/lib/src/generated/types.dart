...
class TypesTable extends _i1.Table<int?> {
  TypesTable({super.tableRelation}) : super(tableName: 'types') {
    ...
    aList = _i1.ColumnList<int>(
      'aList',
      this,
    );
    aMap = _i1.ColumnMap<int, int>(
      'aMap',
      this,
    );
    aSet = _i1.ColumnSet<int>(
      'aSet',
      this,
    );
    aRecord = _i1.ColumnRecord(
      'aRecord',
      this,
    );
  }
  ...
  late final _i1.ColumnList<int> aList;

  late final _i1.ColumnMap<int, int> aMap;

  late final _i1.ColumnSet<int> aSet;

  late final _i1.ColumnRecord aRecord;
