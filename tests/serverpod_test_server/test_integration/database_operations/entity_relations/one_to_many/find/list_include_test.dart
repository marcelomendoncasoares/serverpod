...
void main() async {
  ...
  test(
    ...
    var city = await session.db.findById<int, City>(
      stockholm.id!,
  ...
  test(
    ...
    var organization = await session.db.findById<int, Organization>(
      serverpod.id!,
  ...
  test(
    ...
    var organizations = await session.db.find<int, Organization>(
