...
void main() {
  test(
    ...
    () {
      ...
      expect(jsonMap, {'__className__': 'serverpod_test.Types'});
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(jsonMap, {'__className__': 'serverpod_test.Types', 'anInt': 1});
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(jsonMap, {
        '__className__': 'serverpod_test.Types',
        'aDouble': 1.0,
      });
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(jsonMap, {'__className__': 'serverpod_test.Types', 'aBool': true});
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(jsonMap, {'__className__': 'serverpod_test.Types', 'anEnum': 0});
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(jsonMap, {
        '__className__': 'serverpod_test.Post',
        'content': 'post',
        'next': {'__className__': 'serverpod_test.Post', 'content': 'next'},
      });
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(jsonMap, {
        '__className__': 'serverpod_test.SimpleDataObject',
        'object': {'__className__': 'serverpod_test.SimpleData', 'num': 123},
      });
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(jsonMap, {
        '__className__': 'serverpod_test.TypesList',
        'anObject': [
          {'__className__': 'serverpod_test.Types', 'anInt': 123},
        ],
      });
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(jsonMap, {
        ...
        'aMap': [
          {
            'key': {'__className__': 'serverpod_test.Types', 'anInt': 123},
          },
        ],
      });
    },
  ...
  group('Set', () {
    test(
      ...
      () {
        ...
        expect(jsonMap, {
          '__className__': 'serverpod_test.TypesSet',
          'anObject': [
            {'__className__': 'serverpod_test.Types', 'anInt': 123},
          ],
        });
  ...
  group('Map value -', () {
    test(
      ...
      () {
        ...
        expect(jsonMap, {
          '__className__': 'serverpod_test.TypesMap',
          'anObjectValue': {
            'key': {'__className__': 'serverpod_test.Types', 'anInt': 123},
          },
        });
    ...
    test(
      ...
      () {
        ...
        expect(jsonMap, {
          ...
          'aMapValue': {
            'key': {
              'key': {'__className__': 'serverpod_test.Types', 'anInt': 1},
            },
          },
        });
      },
    ...
    test(
      ...
      () {
        ...
        expect(jsonMap, {
          ...
          'aListValue': {
            'key': [
              {'__className__': 'serverpod_test.Types', 'anInt': 1},
            ],
          },
        });
      },
    ...
    test(
      ...
      () {
        ...
        expect(jsonMap, {
          ...
          'anObjectKey': [
            {
              'k': {'__className__': 'serverpod_test.Types', 'anInt': 123},
              'v': 'value',
            },
          ],
        });
          ...
          'aMapKey': [
            {
              'k': [
                {
                  'k': {'__className__': 'serverpod_test.Types', 'anInt': 1},
                  'v': 'value',
                },
              ],
              'v': 'value',
  ...
  group("Given an object with server only field, ", () {
    test('then the serialized json should not contain server-only field.', () {
      ...
      expect(jsonMap, {'__className__': 'serverpod_test.ScopeServerOnlyField'});
    });
    ...
    test(
      ...
      () {
        ...
        expect(jsonMap, {
          '__className__': 'serverpod_test.ScopeServerOnlyField',
          'nested': {
            '__className__': 'serverpod_test.ScopeServerOnlyField',
            'allScope': {'__className__': 'serverpod_test.Types', 'anInt': 1},
          },
        });
      },
    );
